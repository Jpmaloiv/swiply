                ...
                <div style={{ display: 'flex' }}>
                    <div style={{ flex: 1 }}>
                        <div className='center' style={{ textAlign: 'left' }}>
                            ...
                            <InputGroup>
                                <InputGroup.Prepend>
                                    <InputGroup.Text>https://pv3-dev.herokuapp.com/profile/</InputGroup.Text>
                                </InputGroup.Prepend>
                                <FormControl
                                ...
                                />
                                <CopyToClipboard text={`https://pv3-dev.herokuapp.com/profile/${user.profile || user.id}`} onCopy={() => this.setState({ copied: true })} style={{ cursor: 'pointer' }}>
                                    <InputGroup.Append>
